...
#https://github.com/Apophis23/OSS_proj2.git
...
def dataset_stat(dataset_df):	
	...
	n_class0 = dataset_df.loc[dataset_df["target"]==0].shape[0]
	n_class1 = dataset_df.loc[dataset_df["target"]==1].shape[0]
	return feature, n_class0, n_class1
